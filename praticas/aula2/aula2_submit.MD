...
Entidades : 
produto(<u>codigo</u>,taxaIVA,nome,preco),
encomenda(<u>numero</u>,local),
item(<u>id</u>,quantidade),
fornecedor(<u>nif</u>,nome,email,fax),
tipoFornecedor(<u>codigo</u>,designacao),
condicaoPagamento(<u>codigo</u>,designacao,prazo)

Relacoes :
encomenda "tem"  item
item "tem" produto
encomenda "tem" fornecedor
fornecedor "tem"  condiçao de pagamento e tipo( tipo de fornecedor)
...
```
Todas as relações são binarias
Encomenda-Item (N:M) encomenda tem que ter pelo menos um item: participaçao obridatoria de encomenda
Produto-Item (1:N) participação obrigatoria de Item
Encomenda-Fornecedor (N:1) participação obrigatoria de Encomenda
Fornecedor-codição pagamento (N:1) participação obrigatoria de Fornecedor
Fornecedor-Tipo Fornecedor (N:1) obrigatoriedade de Fornecedor
